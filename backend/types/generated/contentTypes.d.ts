...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Sanota Team'>;
...
export interface ApiChallengeEnquiryChallengeEnquiry
  ...
  attributes: {
    amcDetails: Schema.Attribute.Component<'challenge.amc-details', false>;
    automationDetails: Schema.Attribute.Component<
      'challenge.automation-details',
      false
    >;
    completeSystemDetails: Schema.Attribute.Component<
      'challenge.complete-system-details',
      false
    >;
    consents: Schema.Attribute.Component<'challenge.consents', false>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentSituation: Schema.Attribute.Text & Schema.Attribute.Required;
    desiredOutcome: Schema.Attribute.Text & Schema.Attribute.Required;
    enquiryStatus: Schema.Attribute.Enumeration<
      ['submitted', 'reviewing', 'contacted', 'closed']
    > &
      Schema.Attribute.DefaultTo<'submitted'>;
    equipmentDetails: Schema.Attribute.Component<
      'challenge.equipment-details',
      false
    >;
    industry: Schema.Attribute.String;
    internalRouting: Schema.Attribute.JSON;
    iotDetails: Schema.Attribute.Component<'challenge.iot-details', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::challenge-enquiry.challenge-enquiry'
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    modernizationDetails: Schema.Attribute.Component<
      'challenge.modernization-details',
      false
    >;
    newMachineDetails: Schema.Attribute.Component<
      'challenge.new-machine-details',
      false
    >;
    priorityFlag: Schema.Attribute.Boolean;
    priorityReasons: Schema.Attribute.JSON;
