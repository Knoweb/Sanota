        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {projects.map((project, idx) => (
            <motion.div 
              ...
              className="group flex flex-col rounded-2xl overflow-hidden border border-slate-800 bg-[#0B1220] h-full transition-all hover:border-[#E8B84B]/50 hover:shadow-xl hover:shadow-[#050B14]"
            >
              ...
              <div className="flex flex-col flex-grow p-8 relative z-10 -mt-12">
                <h4 className="text-[20px] font-bold text-white leading-tight mb-4">{project.title}</h4>
